...
import { doBuyTemplate } from "../../../redux/slice/themeSlice";
import './FreeThemeCollection.scss'

export const FreeThemeCard = ({ item, storeId }) => {
            ...
            <Card style={{ cursor: 'pointer' }}>
                <div className="paid-theme-collection__list-theme__item__img-card">
                    ...
                    >
                        ...
                        :
                        <Button variant="secondary" className="theme-card__hover-btn">
                            Remove from theme library
                        </Button>
                        }
                    </div>
                </div>
