                    ...
                    .map((row,index) => {
                        ...
                        selected={isItemSelected}>
                          ...
                          <TableCell align="center" style={{display: 'inline-flex'}}>
                            ...
                            <BaseNumberField key="Price" className={`${row.delete && 'disabled-text'}`} disabled={row.delete} currency={currency} handleChangeCurrency={handleChangeCurrency} placeholder={currency === 'USD' ? '0.00' : '0'} value={row.price} fullWidth={false} setValue={(value) => handleChangePriceVariant(index, value)}></BaseNumberField>
                          </TableCell>
